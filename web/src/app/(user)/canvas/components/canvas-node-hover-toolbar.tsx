...
export function CanvasNodeHoverToolbar({
    ...
    const isNovelAI = node.type === CanvasNodeType.NovelAI;
    ...
    const nodeToolbarTools: ToolbarTool[] = [
        ...
        ...(isNovelAI ? [{ id: "novelai", title: "NovelAI 设置", label: "NovelAI", icon: <Settings2 className="size-4" />, onClick: () => onToggleDialog(node) }] : []),
                            ...
                            <InfoRow
                                ...
                                value={
                                    node.type === CanvasNodeType.Text
                                        ...
                                        ? "音频"
                                        : node.type === CanvasNodeType.NovelAI
                                        ? "NovelAI"
                                        : "生成配置"
                                }
                            />
