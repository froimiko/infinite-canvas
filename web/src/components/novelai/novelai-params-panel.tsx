...
export function NovelAIParamsPanel({ metadata, onChange }: NovelAIParamsPanelProps) {
    ...
    return (
        <div className="na-panel" onMouseDown={(event) => event.stopPropagation()} onPointerDown={(event) => event.stopPropagation()} onWheel={(event) => event.stopPropagation()}>
            <div className="na-field">
                <div className="na-label">图像尺寸</div>
                <NovelAIResolutionSelect value={metadata.size} onChange={(size) => onChange({ size })} />
