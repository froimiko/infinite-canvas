                ...
                items={[
                    {
                        key: "channels",
                        label: "渠道",
                        children: isRemoteMode ? (
                            <Form layout="vertical" requiredMark={false}>
                                <div className="rounded-lg border border-stone-200 p-3 text-sm text-stone-500 dark:border-stone-800">
                                    <div className="font-medium text-stone-900 dark:text-stone-100">云端渠道</div>
                                    <div className="mt-1">由系统后台渠道转发请求，当前可用 {modelChannel?.availableModels.length || 0} 个模型。本地渠道配置在“本地直连”模式下生效。</div>
                                </div>
                            </Form>
                        ) : (
                            <Form layout="vertical" requiredMark={false}>
