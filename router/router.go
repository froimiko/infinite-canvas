...
func New() *gin.Engine {
	...
	api.POST("/prompt-tags/network-translate", middleware.UserAuth, gin.WrapF(handler.PromptNetworkTranslation))
	...
	admin.POST("/prompt-translation/test", gin.WrapF(handler.AdminTestPromptTranslation))
