...
func New() *gin.Engine {
	...
	api.POST("/prompt-tags/search", middleware.OptionalAuth, gin.WrapF(handler.PromptTagAutocomplete))
	api.POST("/prompt-tags/translate", middleware.OptionalAuth, gin.WrapF(handler.PromptTagTranslations))
	...
	admin.GET("/prompt-tag-database/status", gin.WrapF(handler.AdminPromptTagDatabaseStatus))
	admin.GET("/prompt-tag-database/tree/main", gin.WrapF(handler.AdminPromptTagDatabaseMainTree))
	admin.POST("/prompt-tag-database/tree", gin.WrapF(handler.AdminPromptTagDatabaseTree))
	admin.POST("/prompt-tag-database/install", gin.WrapF(handler.AdminInstallPromptTagDatabasePackages))
	admin.GET("/prompt-tag-translation-database/status", gin.WrapF(handler.AdminPromptTagTranslationDatabaseStatus))
	admin.GET("/prompt-tag-translation-database/assets", gin.WrapF(handler.AdminPromptTagTranslationDatabaseAssets))
	admin.POST("/prompt-tag-translation-database/install", gin.WrapF(handler.AdminInstallPromptTagTranslationDatabasePackage))
